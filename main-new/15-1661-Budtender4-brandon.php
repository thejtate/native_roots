...
<body class="page page-budtenders page-brandon">
<div class="b-popup">
  ...
  <div class="content-wrapper">
    <div class="site-container">
      <div class="content-top">
        ...
        <div class="left-part">
          <div class="img-text"><span class="date">February <br/> 2016</span><img src="theme/images/tmp/culture-text-2.png" alt=""/></div>
          <div class="img"><img src="theme/images/tmp/budtender-img-2.png" alt=""/></div>
          <div class="block-title">
            <h1>Brandon Pierre Maniez</h1>
          </div>
          <div class="info">
            <div class="row">
            ...
            <div class="row">
              <div class="title">Favorite Edible?</div><div class="link"><a href="#">VIEW PRODUCT</a></div>
              <div class="desc">
                <p>Marqaha Indica tinctures. The sweet Agave flavor is perfect for anything that could use some sweet.</p>
              </div>
            </div>
            <div class="row">
              <div class="title">Favorite SATIVA?</div><div class="link"><a href="#">VIEW PRODUCT</a></div>
              <div class="desc">
                <p>East Coast Alien</p>
              </div>
            </div>
            <div class="row">
              <div class="title">Favorite INDICA?</div><div class="link"><a href="#">VIEW PRODUCT</a></div>
              <div class="desc">
                <p>Skywalker OG. This is a hard question because I love most indica strains. Orange Herijuana, Master kush, Purple Alien OG, and Lavender Jones are amazing as well</p>
              </div>
            </div>
            <div class="row">
              <div class="title">Two favorite hobbies?</div>
              <div class="desc">
                <p>Reading and playing guitar</p>
              </div>
            </div>
            <div class="row">
              <div class="title">Favorite quote or words to live by?</div>
              <div class="desc">
                <p>"The purpose of education is not to validate ignorance but to overcome it"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="content-middle">
        <div class="full-block">
          ...
          <div class="img img-1"><img src="theme/images/tmp/budtender-img-2-a.png" alt=""/></div>
          <div class="img img-2"><img src="theme/images/tmp/budtender-img-2-b.png" alt=""/></div>
        </div>
      </div>
    </div>
  </div>
